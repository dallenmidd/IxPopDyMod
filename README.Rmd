...
```{r}
transitions_input <- system.file('extdata', 'temp_example_config', 'tick_transitions.csv', package='IxPopDyMod', mustWork = TRUE) %>% read_csv()
parameters_input <- system.file('extdata', 'temp_example_config', 'tick_parameters.csv', package='IxPopDyMod', mustWork = TRUE) %>% read_csv()
weather_input <- system.file('extdata', 'temp_example_config', 'weather.csv', package='IxPopDyMod', mustWork = TRUE) %>% read_csv()

cfg <- config(
  steps = 730L,
  initial_population = c('r_a' = 10L),
  transitions = transitions_input,
  parameters = parameters_input,
  host_comm = data.frame(), # need to specify that there's no host community
