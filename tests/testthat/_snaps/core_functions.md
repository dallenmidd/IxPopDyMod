...
# model output for `config_ex_1` stays the same
    ...
    WAoAAAACAAQCAgACAwAAAAMTAAAAAwAAAA0AAAB0AAAAAQAAAAEAAAABAAAAAQAAAAIAAAAC
    ...
    AAAAAAAAQI9AAAAAAAAAAAQCAAAAAQAEAAkAAAAFbmFtZXMAAAAQAAAAAwAEAAkAAAADZGF5
    AAQACQAAAAVzdGFnZQAEAAkAAAADcG9wAAAEAgAAAAEABAAJAAAACXJvdy5uYW1lcwAAAA0A
    AAACgAAAAP///4wAAAQCAAAAAQAEAAkAAAAFY2xhc3MAAAAQAAAAAwAEAAkAAAAGdGJsX2Rm
    AAQACQAAAAN0YmwABAAJAAAACmRhdGEuZnJhbWUAAAD+

# model output for `config_ex_2` stays the same

    
    ...
    
    ...
    
    ...
    
...
# model output for ogden config stays the same
    ...
    bWVzAAAADQAAAAKAAAAA///u5AAABAIAAAABAAQACQAAAAVjbGFzcwAAABAAAAADAAQACQAA
