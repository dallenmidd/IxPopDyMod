...
ogden2005 <- config(
  ...
  # from, to, fun, transition_type, mortality_type = NULL, predictors = NULL, parameters = list()
    transition("__e", "h_l", expo_fun, "duration", predictors = list(x = predictors_spec_node("temp", FALSE)), parameters = list(a = 2.92e-05, b = 2.27)),
    ...
    transition("e_l", "q_n", expo_fun, "duration", predictors = list(x = predictors_spec_node("temp", FALSE)), parameters = list(a = 9.883278e-06, b = 2.55)),
    transition("e_n", NULL, constant_fun, "duration", mortality_type = "per_day", parameters = list(a = 0.002)),
    transition("e_n", "q_a", expo_fun, "duration", predictors = list(x = predictors_spec_node("temp", FALSE)), parameters = list(a = 0.0006265664, b = 1.21)),
    ...
    transition("e_a", "r_a", expo_fun, "duration", predictors = list(x = predictors_spec_node("temp", FALSE)), parameters = list(a = 0.0007692308, b = 1.42)),
    ...
    transition("q_l", "a_l", ogden_feed_fun, "probability", predictors = list(x = predictors_spec_node("temp")), parameters = list(a = 0.0207, q = 7e-04, tmax = 35, tmin = 10)),
    transition("q_n", "a_n", ogden_feed_fun, "probability", predictors = list(x = predictors_spec_node("temp")), parameters = list(a = 0.0207, q = 7e-04, tmax = 35, tmin = 10)),
    transition("q_a", "a_a", ogden_feed_fun, "probability", predictors = list(x = predictors_spec_node("temp")), parameters = list(a = 0.0459, q = 0.0088, tmax = 16, tmin = 3)),
    transition("a_l", NULL, density_fun, "duration", mortality_type = "throughout_transition", predictors = list(x = predictors_spec_node("host_den"), y = predictors_spec_node("[af]..")), parameters = list(a = 0.65, b = 0.049, c = 1.01, pref = c(deer = 0, mouse = 1))),
    transition("a_n", NULL, density_fun, "duration", mortality_type = "throughout_transition", predictors = list(x = predictors_spec_node("host_den"), y = predictors_spec_node("[af]..")), parameters = list(a = 0.55, b = 0.049, c = 1.01, pref = c(deer = 0, mouse = 1))),
    transition("a_a", NULL, density_fun, "duration", mortality_type = "throughout_transition", predictors = list(x = predictors_spec_node("host_den"), y = predictors_spec_node("[af]..")), parameters = list(a = 0.5, b = 0.049, c = 1.01, pref = c(deer = 1, mouse = 0)))
  ),
