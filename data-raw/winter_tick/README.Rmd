...
Since the growth rate is close to `1` the population is roughly stable. It's more revealing to plot the population over time, split up by life stage. We'll write a simple function to do so.
